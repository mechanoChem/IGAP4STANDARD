...
void getime_field(double *field_, double *u, double *par)
{
double *u1=u+30;
double *u0=u+60;
double comp[36];
...
field_[0]=(u0[0]+u1[0])/2;
field_[1]=(u0[10]+u1[10])/2;
field_[2]=(u0[20]+u1[20])/2;

field_[3]=(*(comp+25));
field_[4]=(*(comp+26));
field_[5]=(1.4999999999999998*pow(field_[3],4) + pow(field_[4],2)*(1.4999999999999998*pow(field_[4],2) + field_[4]*(*(par+0))*(1.9999999999999996 - 1.9999999999999996*(*(par+1))) - 2.9999999999999996*pow((*(par+0)),2)*(*(par+1))) + pow(field_[3],2)*(2.9999999999999996*pow(field_[4],2) - 2.9999999999999996*pow((*(par+0)),2)*(*(par+1)) + field_[4]*(*(par+0))*(-5.999999999999999 + 5.999999999999999*(*(par+1)))))/(pow((*(par+0)),4)*(0.49999999999999983 + 1.*(*(par+1))));
if      ((field_[5]<-0.5) && (field_[4]<0)) {field_[5]=3.0;}
else if ((field_[5]<-0.5) && (field_[3]>0)) {field_[5]=1.0;}
else if ((field_[5]<-0.5) && (field_[3]<0)) {field_[5]=2.0;}
else                                        {field_[5]=0.0;}
}
